 ...
 * @method static \Wahyudedik\LaravelAlert\Contracts\AlertManagerInterface addMultiple(array $toasts)
 ...
 * @method static \Wahyudedik\LaravelAlert\Contracts\AlertManagerInterface addToast(string $type, string $message, ?string $title = null, array $options = [])
 ...
 * @method static \Wahyudedik\LaravelAlert\Contracts\AlertManagerInterface withStack(bool $stack = true)
 * @method static \Wahyudedik\LaravelAlert\Contracts\AlertManagerInterface withProgress(bool $show = true)
 * @method static \Wahyudedik\LaravelAlert\Contracts\AlertManagerInterface withMaxToasts(int $max)
 */
